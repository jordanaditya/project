<?php $__env->startSection('title', 'Hands-On Samsung Galaxy Watch3: Premium, Kaya Fitur'); ?>
  ...
  <article>
    <div class="container">
      <div class="row">
        ...
        <!-- Comments -->
        <?php $__currentLoopData = $komentars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="media mb-4">
          <img class="d-flex mr-3 rounded-circle" src="http://placehold.it/50x50" alt="">
          <div class="media-body">
            <h5 class="mt-0"><?php echo e($k->nama); ?></h5>
            <?php echo e($k->komen); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kuisSatu\resources\views/article/hands-on-samsung-galaxy-watch3-premium-kaya-fitur.blade.php ENDPATH**/ ?>