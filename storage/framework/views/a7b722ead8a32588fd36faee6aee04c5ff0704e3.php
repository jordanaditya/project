...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="homes">NgeReview.com</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item"> <?php echo e(Route::is('homes') ? 'active' : ''); ?>
          ...
          <li class="nav-item"> <?php echo e(Route::is('manage') ? '' : ''); ?>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">Copyright &copy; NgeReview.com 2020</p>
        </div>
      </div>
    </div>
  </footer>
...
<?php /**PATH C:\xampp\htdocs\kuisSatu\resources\views/master.blade.php ENDPATH**/ ?>