<?php $__env->startSection('title', 'Preview Snapdragon 662: Smartphone Murah Jadi Makin Seru!'); ?>
  ...
  <article>
    <div class="container">
      <div class="row">
        ...
        <!-- Comments -->
        <?php $__currentLoopData = $komentarsatu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="media mb-4">
          <img class="d-flex mr-3 rounded-circle" src="http://placehold.it/50x50" alt="">
          <div class="media-body">
            <h5 class="mt-0"><?php echo e($k1->nama); ?></h5>
            <?php echo e($k1->komen); ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kuisSatu\resources\views/article/preview-snapdragon-662-smartphone-murah-jadi-makin-seru.blade.php ENDPATH**/ ?>