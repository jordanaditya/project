      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        <div class="post-preview">
          <a href="<?php echo e($home->link); ?>">
            ...
            <a href="#">
            <img class="img-fluid" src=<?php echo e($home->image); ?> alt="">
          </a>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Jordan\Kuliah\Pemrograman Web Lanjut\Pertemuan 6\kuisSatu\resources\views/homes.blade.php ENDPATH**/ ?>